...
Last StandUp I finished Friends Update api using the second version of store procedures.
...
-   [x] Formik-Material UI: => Add/Edit Registration (React/Formik/MaterialUI)
...
Last StandUp I implemented Formik framework on my AddFriends and AddJobs pages with validation schema I also implemented materialUI on my LogIn and Registration pages.

For this morning, I'll finish implementing Formik on TechCompanies and materialUI on my AddFriends, AddJobs and AddTechCompanies pages. Then once I'm done with that, I'll finish connecting my TechCompaniesApiController with Images batch Insert
...
Last StandUp I implemented Formik framework and client side validation on my AddTechCompanies page.

Today I'll finish connecting my TechCompaniesApiController then move on to Events.

No blockers.

# Daily Task

-   [x] Formik: => Add/Edit TechCompanies (React/Formik)
-   [x] Client-Side Validation: => Add/Edit TechCompanies (React/Yup)
-   [x] TechCompany: Insert w/ Image batch (Sql)
-   [x] TechCompany: Update w/ Image batch (Sql)
-   [x] TechCompanyApiController: Insert (C#/.NET)
-   [x] TechCompanyApiController: Update (C#/.NET)
-   [x] TechCompaniesService: Insert (C#/.NET)
-   [x] TechCompaniesService: Update (C#/.NET)
...
-   [🗸] Friends CRUD Store Procs (Sql) _100%_
...
-   [🗸] FriendsApiController (C#/.NET) _100%_
...
-   [🗸] Jobs CRUD Store Procs (Sql) _100%_
...
-   [🗸] JobsApiController (C#/.NET) _100%_
...
-   [🗸] TechCompany CRUD Store Procs (Sql) _100%_
    ...
    -   [x] TechCompany: Insert w/Image batch (Sql)
    -   [x] TechCompany: Update w/Image batch (Sql)
-   [🗸] TechCompaniesService (C#/.NET) _100%_
    ...
    -   [x] TechCompaniesService: Insert w/Image batch (C#/.NET)
    -   [x] TechCompaniesService: Update w/Image batch (C#/.NET)
-   [🗸] TechCompanyApiController (C#/.NET) _100%_
    ...
    -   [x] TechCompanyApiController: Insert w/Image batch (C#/.NET)
    -   [x] TechCompanyApiController: Update w/Image batch (C#/.NET)
-   [🗸] Formik (React/Formik) _100%_
...
Last StandUp I implemented Formik framework and client side validation on my AddTechCompanies page and connected my TechCompaniesApiController to my React Endpoints. Answered some React Interview Prep Questions.

Today I'll start with Events page full stack, and finish the rest of the React Interview Prep Questions.
...
-   Product meeting @10
-   After lunch: start of the Database
