...
import SearchBar from "./StarterTaskComponents/SearchBar";
import JobsSearchBar from "./StarterTaskComponents/JobsSearchBar";
import "./App.css";
import "./st.css";
      ...
      <React.Fragment>
        ...
        <main role="main">
          ...
          <Route
            ...
            component={Friends}
          ></Route>
          <Route path="/friends" exact={false} component={SearchBar}></Route>
          ...
          <Route path="/jobs" exact={false} component={JobsSearchBar}></Route>
        </main>
        <Footer></Footer>
      </React.Fragment>
    );
