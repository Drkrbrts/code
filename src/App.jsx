...
//Stopped at jobs/techCompany
//Need to create tables/storedProcs for TechCompany and finish Jobs
//Jobs 99% done. Need to call TechCompany getAll(ajax call) on componentDidMount inside JobsForm to map the data as a List on the FORM
