...
class Widget extends React.Component {
  ...
  //     let widgets = response.data.items;
  //     console.log(widgets);
  //     this.setState((preState) => {
  //       return {
  //         mappedWidgets: widgets.map(this.mapWidget),
  //       };
  //     });
  //   };
  //   mapWidget = (oneWidget) => {
  //     return (
  //       <React.Fragment key={`widgets-${oneWidget.id}`}>
  //         <SingleWidget singleWidget={oneWidget}></SingleWidget>
  //       </React.Fragment>
  //     );
  //   };
  ...
  render() {
    return (
      <>
        ...
        <div className="row">{this.state.mappedWidgets}</div>
      </>
    );
  }
}
