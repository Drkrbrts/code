...
class FriendForm extends React.Component{
    ...
    onChangeState = (e) =>{
        ...
        this.setState(()=>{
          let newState = {...this.state.fromData}
      ...
      onSubmitBtnClick = (e) =>{
        ...
        const payload ={
            title: this.state.fromData.title
            ,bio: this.state.fromData.bio
            ,summary: this.state.fromData.summary
            ,headline: this.state.fromData.headline
            ,slug: this.state.fromData.slug
            ,statusId: this.state.fromData.statusId
            ,primaryImage: this.state.fromData.primaryImage
           }
