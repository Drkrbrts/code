...
onSubmitWidgetSuccess = (response) =>
{
 ...
 messageSuccess = (response) => {
    ...
    toast.success(`${this.state.formData.nameOfCar} was created successfully. Save your ID number: ${entityId}`, 
        {
        position: "top-right",
        autoClose: 5000,
                    ...
                    <div className="card" >
                      <div className="card-body p-5">
                        ...
                        <form>
                          ...
                          <div className="form-outline mb-4">
                            <input type="text" name="description" id="description" className="form-control form-control-lg" value={this.state.formData.edescriptionmail} onChange={this.onFormFieldChanged}/>
