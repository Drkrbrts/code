...
class Card extends React.Component      // pass props from the card -> to EventsMain -> change state of EventsMain
{
    ...
    componentDidMount = () =>
    {
        ...
        let eventDate = new Date(eventInfoFromCard.metaData.dateStart);
        let eventDay = eventDate.getDate();
        let eventMonth = eventDate.getMonth();
        let eventYear = eventDate.getFullYear();
        let formatedEventDate = `${eventMonth}/${eventDay}/${eventYear}`;
        eventInfoFromCard.metaData.dateStart = formatedEventDate;

        if (eventInfoFromCard.name === "Orpheus Park")
        {
