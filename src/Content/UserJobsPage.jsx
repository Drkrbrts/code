    ...
    mapJobs = (job) => {
        return (
            <React.Fragment key={job.id}>
                <RenderJob
                    job={job}
                    editThisJob={this.onEditClick}
                    viewThisJob={this.toggleModal}
                />
            </React.Fragment>
        )
    }
            ...
            <React.Fragment>
                ...
                <div className="row">
                    ...
                    <ModalViewMore
                        ...
                        title={this.state.jobDetails.title||"Title"}
                        description={this.state.jobDetails.description||"Description"}
                        summary={this.state.jobDetails.summary||"Summary"}
                        pay={this.state.jobDetails.pay||"Pay"}
                        skills={this.state.jobDetails.skills||"Skills"}
                        company={this.state.jobDetails.companyName||"Company"}
                    />
                    <Pagination 
