...
class Cars extends React.Component {
  constructor(props) {
    ...
    this.handleFilteredCars = this.handleFilteredCars.bind(this);
    this.handleHide = this.handleHide.bind(this);
    this.handleShow = this.handleShow.bind(this);
  }

  componentDidMount() {
    this.handleFilteredCars("all");
  }

  renderCars = () => {
    this.setState((prevState) => {
      return { ...prevState, mappedCars: prevState.cars(this.mapCar) };
    });
  };

  handleFilteredCars = (year) => {
    let cars = this.state.cars;

    let filteredCars =
      year === "all"
        ? cars
        : cars.filter((oneCar) => oneCar.year.toString() === year);

    this.setState((prevState) => {
      return { ...prevState, mappedCars: filteredCars };
    });
  };
        ...
        <div className="dropdown">
          <div className="form-group">
            ...
            <select
              ...
              onChange={(event) => this.handleFilteredCars(event.target.value)}
            >
