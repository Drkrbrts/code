...
export { logIn, register, loginUser, currentInfo, getUser, userLogout, getFriends, deletePerson, editFriend, friendData, addFriend, searchFriend}; // export all your calls here
