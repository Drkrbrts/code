...
class Friends extends React.Component{
    ...
    onSubmitClicked =()=>{
        ...
        if(this.props.location.state)
        {
            friendsService.update(personData)
                .then(this.onUpdateSuccess)
                .catch(this.onUpdateError);
        }
        else{
            friendsService.add(personData)
    ...
    render()
    {
        return (
            <React.Fragment>
                <div style={{border: "solid 1px lightgray", boxShadow: "1px" ,margin: "0 0 0 70px"}}>
                    <h1 className="px-3">Add or Edit Friend</h1>
                </div>
                <div style={{border: "solid 1px lightgray", width: "50%",margin: "0 0 10px 70px", padding: "60px"}}>
                    <label>Title</label>
                    <input 
                        type="text" 
